package student_rolands_gudels.lesson_9_interfaces.level_8_architect;

public class Task_29 {
 /*   Для нашей организации большая честь, что вы с нами.
    Ваша упорная работа приведёт нас к вершине и позволит
    выполнить все поставленные цели. Так держать!
