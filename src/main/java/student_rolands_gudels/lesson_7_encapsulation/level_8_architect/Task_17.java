package student_rolands_gudels.lesson_7_encapsulation.level_8_architect;

public class Task_17 {
   /* Наивысшая награда за труд человека - это не то, что он получает за него,
    а то, чем он благодаря этому становится.
