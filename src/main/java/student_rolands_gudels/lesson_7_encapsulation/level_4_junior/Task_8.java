package student_rolands_gudels.lesson_7_encapsulation.level_4_junior;
...
public class Task_8 {
   /* Как научиться писать простые, понятные и маленькие методы?
    ...
    Например решение супер таска из одной из предыдущих лекций.
    ...
    Убедитесь, что ваш код стал более читаемым и в нём проще разобраться.
