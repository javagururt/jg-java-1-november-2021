package student_rolands_gudels.lesson_5_arrays_for_loop.level_8_architect;

public class Task_43 {

//    Даже самая маленькая из хорошо выполненных работ сделает
//    вас на шаг ближе к успеху, о котором вы всегда мечтали. Так держать.
//
//    Even the smallest of jobs well done will take you one step closer
//    towards the success that you have always dreamed about. Keep it up.
//
//
...
//    в этих главах.
//
//- попробуйте порешать задачи на сайтах:
