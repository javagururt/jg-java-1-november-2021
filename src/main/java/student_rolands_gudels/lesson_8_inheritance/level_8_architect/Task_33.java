package student_rolands_gudels.lesson_8_inheritance.level_8_architect;

public class Task_33 {
/*    Секрет успеха в том, чтобы относиться к любой работе
    как к возможности исследовать, а не как к скучной работе. Поздравляем.

    The secret to success is to treat any job as an opportunity to explore,
    rather than something that is a boring chore. Congratulations.
