package student_rolands_gudels.lesson_6_arrays_while_loop.level_8_architect;

public class Task_35 {
/*    Ваш упорный труд и усилия окупились! Успех заслуженный,
    событие, которое стоит отметить! Поздравляем!
