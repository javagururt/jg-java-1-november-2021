...
public class Task_15 {
 /*   Добавьте в класс ArrayService метод для замены всех вхождений
    ...
    Подсказка: может ли количество произведённых замен быть
    полезной информацией для того кто вызывает этот метод?
    Если да, то подумайте как вернуть это значение из метода.
