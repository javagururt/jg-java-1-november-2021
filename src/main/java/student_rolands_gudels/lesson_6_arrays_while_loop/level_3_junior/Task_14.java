...
/*    Добавьте в класс ArrayService метод для замены первого вхождения
    ...
    Подсказка: может ли стать факт произошла замена или нет
    полезной информацией для того кто вызывает этот метод?
    Если да, то подумайте как вернуть этот факт из метода.
