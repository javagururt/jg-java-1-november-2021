...
public class Task_8 {
    ...
    Вторая часть - это нахождение по номеру дня недели его названия
            (оператор switch) и вывод названия дня недели на консоль с помощью
...
- вывод на консоль названия дня недели.
    ...
    это не так. Команде System.out.println нужно передать значение,
    ...
    В реальных проектах очень часто консоли просто нет! Результат
    вычислений нужно доставлять на веб страницу или в мобильное
