package student_stanislav_p.Lesson_2.level_5_middle;
...
public class Lesson2_Task_15 {
    ...
    public static void main(String [] args) {
         ...
         System.out.print("Пример использования команды System.out.print");



        System.out.println("  и Пример использования команды System.out.println");
        System.out.println("  Второй Пример использования команды System.out.println");
    }
