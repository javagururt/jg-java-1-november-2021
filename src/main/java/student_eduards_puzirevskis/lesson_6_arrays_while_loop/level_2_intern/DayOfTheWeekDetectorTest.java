...
public class DayOfTheWeekDetectorTest {
    ...
    public void shouldReturnMonday() {
        ...
        checkTestResult("Monday".equals(dayOfTheWeek), "Should Return Monday");
    }

    public void shouldReturnTuesday(){
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeekNumber(2);
        checkTestResult("Tuesday".equals(dayOfTheWeek), "Should Return Tuesday");
    }

    public void shouldReturnWednesday(){
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeekNumber(3);
        checkTestResult("Wednesday".equals(dayOfTheWeek), "Should Return Wednesday");
    }

    public void shouldReturnThursday(){
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeekNumber(4);
        checkTestResult("Thursday".equals(dayOfTheWeek), "Should Return Thursday");
    }

    public void shouldReturnFriday(){
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeekNumber(5);
        checkTestResult("Friday".equals(dayOfTheWeek), "Should Return Friday");
    }

    public void shouldReturnSaturday(){
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeekNumber(6);
        checkTestResult("Saturday".equals(dayOfTheWeek), "Should Return Saturday");
    }

    public void shouldReturnSunday(){
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeekNumber(7);
        checkTestResult("Sunday".equals(dayOfTheWeek), "Should Return Sunday");
    }

    public void shouldReturnNotCorrectDayNumber(){
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeekNumber(8);
        checkTestResult("Not correct day number".equals(dayOfTheWeek), "Should Return Sunday");
    }
