...
@CodeReviewComment(comment = "currentGeneration[i][j] == true можно упростить до currentGeneration[i][j]" +
        "currentGeneration[i][j] == false до !currentGeneration[i][j]." +
        "метод calculate достаточно большой. Попробуйте разделить на 2-3 метода (обратите внимание на части, которые повторяются) ")
